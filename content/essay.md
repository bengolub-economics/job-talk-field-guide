# How to give a better job talk

Benjamin Golub · September 11, 2026

[Slides handout (PDF)](deck_handout.pdf){.handout-link} [Gallery of before-and-betters](https://bengolub-economics.github.io/job-talk-field-guide/){.gallery-link} [Presentation resources](resources.html){.resources-link}
...
- How admitting a weakness can help you come across as a stronger economist.
- Why six crowded blackboards can be a pleasure to follow while one crowded slide frustrates and loses the audience.
...
## A talk is an optimization problem

Here’s the principle: a talk, for those of you who care about being academically employed, is a very important optimization problem in your career. Your objective is to maximize what I call weighted understanding. You could also think of it as how impressed people are—their evaluation of you—with different weights on different audience members. Critically, that depends on the attention they choose to pay:

$$
\max_{p\in\mathcal{P}}\sum_{i=1}^{n}w_i U_i\bigl(p,a_i^*(p)\bigr).
$$

Here, $p$ is your presentation—the words and visuals—$w_i$ is the weight on listener $i$, $U_i$ is their understanding, and $a_i^*(p)$ is their chosen attention.
...
$$
a_i^*(p)\in\operatorname*{arg\,max}_{a_i\in[0,1]}
\left\{V_i(p,a_i)+R_i(1-a_i)\right\}.
$$

$V_i$ is the value of following the talk; $R_i$ is the value of other uses of attention. An attention level of one means full attention to you. But something else in the modern world is pretty compelling: a family group chat, an argument on Twitter, their own career worries. Whatever is important to you, remember that other people have similarly compelling distractions. Holding their attention is not an easy problem.

Whether they keep listening comes down to three questions. “Can I follow?” is the main one: if they can’t, they’re gone. “Do I care?” matters too. The subject needn’t have been important to them ex ante, but they have to care in some way while they’re listening, the way they do in a movie. The third question is what else they could be doing, which sets a benchmark for how good the answers to the first two questions have to be. When practicing aloud, you’ll sometimes feel uncomfortable because what you’re saying is boring even to you. That's your hint that it's probably way below your audience's outside option.
...
Often, the expert has to be impressed too. There are two sorts of champions: one (the best kind) is already fully impressed, helps you give the best talk you can and asks only helpful questions. The other, harder, kind of champion wants to hire you but treats the talk to some extent as an exam, perhaps saving a hard question for the seminar. This is why it’s hard to get a good academic job. You have to achieve broad appeal and, at the key moment, answer that difficult question. You can do both, but you can see why it’s going to take all of your powers.
...
> We set up differentiated Bertrand with quasilinear preferences and constant marginal costs. Own-price demand is locally linear; the planner observes noisy demand derivatives and quantities. We normalize the Slutsky matrix and diagonalize pass-through. The key condition is significant structure—large eigenvalues relative to the noise, with nonvanishing quantity projections. Given diagonal recoverability, we project onto the estimated eigenspace and apply Davis–Kahan. That gives asymptotic robustness and the full-information surplus bound under nonnegative consumer-surplus incidence. We also have an impossibility result, an empirical diagnostic, and extensions beyond local linearity.

That second version gives you assumptions, a method, a result, and extensions. If you already know what all those things are, you might be able to reconstruct why the paper matters. But someone who isn’t already working on this problem has barely got past the first sentence before I’m telling them about spectral projections. I’ve given them more things to understand without giving them a reason to care.
...
Claude can generate five progressively stronger versions of your most diffident pitch; choose one and ask your advisor what’s comfortable. Learning your field’s norms is part of growing as a researcher. Most students don’t ask this question, but advisors often have surprisingly useful things to say. For field-specific examples, watch recorded talks by people you learn from.

Once people know what you’ve contributed, you can give your setup and results, followed by other findings, implications, and limits.

## Be bigger than your paper

A question came up here: how do you talk about limits?

Don’t preempt by foregrounding the thing you fear most. Do prepare great answers to the questions people will ask. Usually these don’t require great expertise in the literature: “You claim that households are dynamically rational about electricity consumption. But are they actually? Is there any evidence of intertemporal substitution?” Talk to ten smart friends and you’ll soon know the most common five or ten questions.

Your goal in a job talk is not to convince people that this is the best paper ever written, unless it is. It’s usually not. Your goal is to present yourself as a credible expert who can show the work in its best light and also be authoritative about the ways in which it’s incomplete.
...
This brings up the question of what you should listen to your advisor about. On intellectual matters and the politics of your field, your advisor is a genius and an expert. Ask them a lot of questions. You’ll learn so much, and people don’t ask enough of these questions.

On exposition, recognize that most economists don’t care enough about it. A lot of us got jobs when getting hired was easier and communication mattered less, so senior people will say, “Just focus on that next result. The talk will work itself out.” If your advisor isn’t emphasizing presentation heavily, listen to others (like me) who do. At the margin, it’s so important.

By the way, as a general matter, when talking to your advisor, give them choices. “This or that?” is a much better start than “How should I get around this very hard problem?”

## Takeaways before details

At both the section and slide level, the principle is: no mysteries. Do not keep anything simple and important secret from your audience that they have the capacity to understand. That’s counterintuitive when you’re used to giving evidence, caveats, and assumptions first. But this material is hard enough to get across even when you’re doing your best to be clear.

The curse of knowledge is a terrible enemy here. You know so much about your work, especially where it’s going, that it’s hard to imagine what isn’t clear to other people. Part of your talk should be accessible to a B-plus undergraduate who struggles to follow much of it. Even that person should leave with a few simple sentences giving the gist. That’ll be of surprising value even to distinguished professors.
...
One of the most useful practical suggestions follows from this model of audience attention. Last year’s practice talks took a necessarily jagged path through the details. What most lacked was a conscious, unmissable broad account of what was going on.

I think of it as a train. There’s the local, taking the scenic route through all the details, and then there’s the express line, which is mostly what your audience can manage. Your talk necessarily covers the local stops, but it must also make the express train path clear.
...
That’s a fictional paper, but you could follow the account with no further explanation. Five stops is a pretty good benchmark: split the talk into five parts and return to this level at each stop, perhaps for two minutes. Even experts will find it helpful to regroup around what you really want to say.
...
These breaks should be where you deliver segments of that talk. When you get into the details, things seem small and the stakes get lost, so this is a chance to remind people why they matter. Remove boring parts if you can. If they have to be there for good intellectual reasons, most of your audience needs a few explanations of why.

There’s value in pure repetition too: some people weren’t listening or didn’t understand. These points are the beams supporting the whole structure of your talk. Repetition is part of what makes the beams thick in the audience’s perception.

Some segments will be boring or too hard—really two versions of the same thing. These stops let people get back on board. For theorists, people may have been reminded of their trauma from first-year microeconomics and stopped listening. Bring them back with something as simple as, “Remember, this axiom is what takes us out of the expected utility framework.”

At lunch, when someone’s attention drifts, you intuitively bring it back: ask about their life, or stop telling them details they don’t seem interested in. In a practiced, regimented talk, we stop behaving this way. Think of yourself as a performer who can use what you observe to get attention back. You’ll see people wake up. If you’re really good, you can add stops dynamically; for a job talk, plan them.

![A detailed path through the argument, with five stops where the audience can rejoin the broad account.](</Users/benjamingolub/Documents/ChatGPT/JM wisdom/output/talk/images/slide-10.png>)
...
Someone also asked how to signal elegantly that you’re moving between the big picture and the details. Two sentences I find effective are “Now I’m going to talk briefly about the big picture,” and “Now let me get into the details of the identification that I’m sure you really care about.”

If you know someone—perhaps an interviewer—and it feels comfortable, say, “X will probably care about this,” or “Now, for the econometricians, I’m going to focus on X.” Being explicit about what you’re doing rhetorically isn’t awkward, and people often appreciate it. At a minimum, it shows that you care and have thought about it. You don’t have to hide the seams.

## About twenty slides

Job talks are, I think, 75 minutes at the median now. Some business school groups have gone to 60, and people with many job talks will have at least one that short. Some still have 90-minute talks, but plan for 75: questions make 90 feel like 75.

Really good talks tend to allow about three minutes per slide. An animation build doesn’t count as a new slide; I mean distinct visual displays. That gives you 30 real slides in a good 90-minute talk, but only about 20 for the core material, because you can’t count on getting through more than 20.
...
Stripping down will make you see your work more clearly. Steve Jobs—in some sense the greatest entrepreneur in recent history—put a lot of his special energy into taking unnecessary things away. Keep asking, “Does this have to be there? Is there a version that’s cleaner, that’s less noisy?” Start from the skeleton of the important ideas—the answers to Matt Jackson’s questions—and make them unmissable. Build that main track first, then add the detailed path.

## Set deadlines and adjust as you go

Your time is not under your full control. Practice talks will give you a workout and show you how little control you may have. But you are ultimately responsible: no matter how difficult the audience is, it’s bad for you if your talk goes badly.

Finish the introduction by 10 minutes, ideally. If it isn’t finished by 15, I consider that an emergency—especially if people are giving you a workout.

A question came up about what counts as an introduction. For a theorist, the model should start by minute 15. The introduction should be something anybody can listen to, usually without symbols; two to four slides is a good length. When people ask, “Do you mean this technical thing or this?”, say, “I will be delighted to talk about that in the results section.” Certain people will extend your introduction into the whole talk unless you stop them. Otherwise you lose.

Finish the background and get to the substance of the main results by minute 35. Missing that landmark is strongly correlated with bad talks. By 60, you should have conveyed the critical substance.

![Timing landmarks: finish the introduction around 10 minutes; 15 minutes is an emergency; discuss main results by 30–35 minutes; convey the essential contribution by 60 minutes.](</Users/benjamingolub/Documents/ChatGPT/JM wisdom/output/talk/images/slide-15.png>)
...
Keep looking at the clock and making those decisions. If you do this well, nobody knows you were pressed for time. There’s no dishonor in spending less time on something. The only dishonor is being at minute 55 when it’s common knowledge that you’re nowhere near where you hoped to be. Take the pain in smaller doses earlier, and you’ll be much better off.

### Practice the shorter versions aloud {.paragraph-heading}

Write out the collapsed sections and practice them aloud in a shorter talk: “If time permits, I’ll do the detailed version of this piece.” This is the one talk you’ll know well enough to make those choices. When needed, think, “Oh, I’m doing version B.” Otherwise you’ll involuntarily say, “I really hoped to have more time to talk about this.” Don’t. “I’ll explain this part at a high level” sounds confident. “Ah, I have to skip past these two slides” sounds apologetic. Skip them as if that was always your intention, with no stress visible.

Remember that you are the steward of a very precious asset: the time of an audience at a place where you hope to get a job. If you’re not careful, someone will get in the way of using it as you’d hoped, and by the end of the talk you’ll feel like you squandered the resource. By making a clear plan for how you will budget it all along the way, you’ll avoid that terrible feeling.

## Choose detail that carries insight

People often act as if everything entered into evidence by being put on a slide has been absorbed. In practice talks, I’d ask, “Did you really expect that when you showed that slide earlier, I fully absorbed its content?” The speaker would sheepishly admit they couldn’t reasonably expect that. Track how much understanding you get out of what you tell people. That will force you to choose detail that carries insight.

Your talk is not your paper. Strip away a lot and focus on a few load-bearing details. It’s often acceptable to say, “I’m not going to show you the full assumption. I’m going to show you the assumption in a simplified case.”
...
Build up from the simple version and you can say the same precise thing to the experts, while everyone else gets some way toward understanding it. Start with the complex version and you’re accessible only to experts who can understand it all.
...
![Two versions of a stock-return equation: the second removes the explicit bin summation and indicator, while retaining the demand shock and its multiplier.](</Users/benjamingolub/Documents/ChatGPT/JM wisdom/output/talk/images/slide-12.png>)

*An equation before and after simplification, from Julie Fu’s slide-design deck.*

That’s completely acceptable. When you look at a detailed slide, imagine covering a long word or notationally heavy expression. If that wouldn’t lose much of the meaning, do it—even with a box. If the expert asks, “But what’s in that box? That really matters,” uncover it and be happy to explain.

Visually overwhelming slides signal that people should stop listening. I don’t even feel bad about it: if someone has a poorly designed, overwhelming slide, I feel like they’ve violated the social norm and should be punished. So I look at my phone.

## Let the slide unfold

Visual complexity is not always bad. It’s a problem when it confronts you all at once. Think back to an undergraduate math class where the professor filled six boards and it was a lovely experience. It was very dense, but if the professor was good, those six boards were a good thing. What mattered was that they built up slowly.
...
As an equation is explained, some detail goes away and other parts are emphasized, with text describing the emphasis. When the speaker discusses an assumption about the shocks, those shocks are highlighted in the equation. For the “deaf” audience member, the visual tracks your voiceover. Not every slide should have this much detail, but if you’re spending three or four minutes on it, you can fill it up. You just have to fill it up slowly.

The big-picture story stays in view. With separate slides, by the third one someone might have forgotten the data or want to look back at the time period. Density is a choice: you wouldn’t put the whole talk on one slide, but keeping key information visible helps people work through a detail.
...
*After the explanation, some of the detail goes away.*

## Minimize tables with lots of numbers!

I hope to see very few tables in your practice talks. Nobody wants to look at tables, and you don’t have to take it from me: Paul Goldsmith-Pinkham is my guide on presentation, and his work is entirely empirical. The high-status view in empirical economics is that tables make poor slides.

Put up a big table and say, “Let me point out this coefficient,” and your presentation looks dated. There’s economic growth: we’re better at what we do now. Making a good visual used to be difficult; now it’s literally one prompt. Why are you not typing that prompt?

Give Claude your table and say, “Make me some beautiful visuals in the style of Paul Goldsmith-Pinkham that will convey all the same information in a memorable way.” Unless your empirical advisor says there’s a serious intellectual threat to your paper without showing the whole table, don’t show it. I promise this will improve your job placement by a detectable amount.
...
Somebody cared about this. That’s what stands out in Julie’s slide examples, and it’s the thought I want to leave you with. A lot of people treat exposition as something to do after the substantive work. What they’re really saying is, “Let me treat this extremely difficult craft, which people spend years getting good at, as an afterthought, and it’ll be fine.”
...
This is an important moment in your career. How well you do will affect whether you seem serious, impressive, and in control, or unprepared for the performance. On the market, unless the substance of your work is really a disaster, I would shift a lot of energy to getting that performance right. The beauty, relative to when I was doing this, is how much material is available: great advice about design and good videos of talks by good economists. There’s a lot to be inspired by.

## Q&A

**Should the introduction build slowly through the setting and motivation, or go straight to the question and answer?**

Start with the shortest introduction that’s truly understandable. Audiences arrive energized, but you have less time than you think: moving slowly invites distractions and gives people more premises to question. Defer questions when necessary, but remember that each “Hold off” has a cost.

Write the essential two or three minutes, then build toward 10 by adding only what you can see is missing. If practice shows it’s too short, you can expand it.

For an econometrician, that may mean explaining distinctions familiar to experts. I’ve never deeply internalized the difference between inference and estimation. First write the shortest version Isaiah Andrews would understand; then explain what someone like me needs to follow it.

Test it on a friend. If they don’t see why the question matters, give one familiar economic setting and explain what we cannot learn unless we get this right. One convincing example usually beats three. If they still don’t see how it changes empirical practice, add a sentence.

You needn’t explain everything yet. If getting the standard errors right changes empirical practice, you can say, “This changes the estimates in these important settings, and I’ll show you how.” The audience knows what you’ve claimed and can assess the evidence later.

Watch plenaries by Andrews, Guido Imbens, or another good econometrician speaking to a broad audience. With these questions in mind, you’ll see how they handled the same trade-offs and find choices you can use.

**What if people keep asking, “Why do you care? Why is this useful?”**

Don’t try to settle every challenge in your opening. A word or two can head off some questions, but your goal is to tell people something good in a short statement; then answer what they ask.

The student who asked this had a paper on the organization of information acquisition. I suggested naming a realistic phenomenon the traditional model cannot explain. It needn’t be a specific real-world case. You can admire the old theory while saying that its simplicity limits its realism and that studying this question requires richer models. Then give one well-chosen example.

If they accept that the behavior exists but still ask about its economic consequences, explain your curiosity and what grew out of it: “If we relax this unrealistic assumption, can we solve anything? The answer gives us a rich but tractable system for studying this important margin.” For a good theory, the value of the question is ultimately what grows out of it: you can point to new forces that weren’t visible before.

You can’t convince the ultimate skeptic, and you don’t need to apologize for their lack of interest. Usually they want to know how you thought about the problem and whether you can explain its interest from several angles. Give that mature account instead of falling back on “My advisor told me to extend X.”

**Should I give a 15-minute version of the whole talk first, and then go into the details?**

There’s a version where you give a 15-minute conference talk and then switch to the main talk. I wouldn’t do exactly that. It gives you a pretty good guarantee of getting the core ideas across, but it can feel awkward because you’re literally repeating yourself.

I think it’s better to distribute those 15 minutes through the talk, provided you really commit to doing it. Still, for a talk that’s sufficiently complicated or likely to get derailed, giving the short version first can be reasonable.

**What about asking chatbots for presentation advice?**

For taste, unfortunately, they’re terrible. One of my slides was made in a rush, and you could hear the Claude taste in the title. I wouldn’t trust them for slide titles. For advice on visuals, Claude tends to be better for me, though those capabilities change week to week.

They can be very helpful when you give them a good example. Get a transcript from the YouTube video of an Imbens talk, provide your paper, and ask, “How can I give an Imbens-style, high-level introduction to this material?” It won’t give you a perfect output, but it’ll give you something very stimulating.
